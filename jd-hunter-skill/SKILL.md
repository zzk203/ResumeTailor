...
4. 获取 JD 详情页内容
5. 对每条 JD 调用 LLM 评分（1-10），筛选 ≥7 分条目
...
```bash
# 完整猎取流程
python -m jd-hunter-skill.src.main hunt personal_info.md

# 单步操作
python -m jd-hunter-skill.src.main search boss "后端开发" --city 北京
python -m jd-hunter-skill.src.main score jd_file.md personal_info.md
