...
- `python src/tools.py batch-assemble <template_file> <personal_info_file> <jd_dir> [--fill-ext .json] [--output-dir ./output]` — **批量组装**：jd_dir 下每个 `.md` JD 文件自动匹配同名 `.json` 填充映射，批量生成所有简历
